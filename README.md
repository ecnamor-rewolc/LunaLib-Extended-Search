...
Or keep the existing static path and place a `.gif` with the same base name alongside the `.png` — LunaLib fork will prefer the `.gif` automatically.
